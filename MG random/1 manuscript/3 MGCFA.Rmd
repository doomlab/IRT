...
### FIGURE ME OUT ### 
- check original lap for questions and factors
- check lap-r for updated versions, but no social desireability for the analysis
- https://myharrisburgu-my.sharepoint.com/:u:/g/personal/ebuchanan_harrisburgu_edu/EVhsnjcMtltPhGo1PZu8SH0BEzfd0aZsHzLgkmXv90xkDw?e=vTA0VP
...
#### FIX ME take out stms and only use VIL####

these columns are labeled VIL - look at PDF for factors
STMS columns are this college scale we don't want to use 
