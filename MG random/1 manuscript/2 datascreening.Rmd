...
summary_ds[nrow(summary_ds)+1, ] <- 
                    #scale name, sample size
                    c("BP", sum(!is.na(bpsf_df$fulldata$outliers)),
                      # missing points, number outliers
...
summary_ds[nrow(summary_ds)+1, ] <- 
                    #scale name, sample size
                    c("BP", sum(!is.na(brs_df$fulldata$outliers)),
                      # missing points, number outliers
...
summary_ds[nrow(summary_ds)+1, ] <- 
                    #scale name, sample size
                    c("BP", sum(!is.na(dms_df$fulldata$outliers)),
                      # missing points, number outliers
...
summary_ds[nrow(summary_ds)+1, ] <- 
                    #scale name, sample size
                    c("BP", sum(!is.na(elm_df$fulldata$outliers)),
                      # missing points, number outliers
...
summary_ds[nrow(summary_ds)+1, ] <- 
                    #scale name, sample size
                    c("BP", sum(!is.na(elq_df$fulldata$outliers)),
                      # missing points, number outliers
...
summary_ds[nrow(summary_ds)+1, ] <- 
                    #scale name, sample size
                    c("BP", sum(!is.na(emas_df$fulldata$outliers)),
                      # missing points, number outliers
...
summary_ds[nrow(summary_ds)+1, ] <- 
                    #scale name, sample size
                    c("BP", sum(!is.na(ems_df$fulldata$outliers)),
                      # missing points, number outliers
...
summary_ds[nrow(summary_ds)+1, ] <- 
                    #scale name, sample size
                    c("BP", sum(!is.na(es_df$fulldata$outliers)),
                      # missing points, number outliers
