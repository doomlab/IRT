...
apa_table(cor_table,
          ...
          col.names = c("Item", "Differences", "Items Changed", "Where Changed", 
                        "Item Directly After", "Direction of Change", 
...
Mirroring the results for the PIL, the correlation matrices for the randomized and nonrandomized versions of the LPQ were significantly different, $\chi^2$(`r cortestLPQ$df`) = `r printnum(cortestLPQ$chi2)`, *p* < .001. Less differences in correlation were found, only `r diffLPQ` out of the possible 190 combinations. The differences are summarized in Table \@ref(tab:cor-table). Most of the items affected one to four other items with item 13 *reliable person* showing the largest number of differences in correlation. All these changes were positive, meaning the correlations were larger for nonrandomized versions. 
