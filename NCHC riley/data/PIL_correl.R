...
PIL[ , c("PIL2", "PIL5", "PIL10", "PIL14", "PIL15", "PIL17", "PIL18", "PIL19")] = 8 - PIL[ , c("PIL2", "PIL5", "PIL10", "PIL14", "PIL15", "PIL17", "PIL18", "PIL19")]
...
library(mice)
tempnomissrandom = mice(replacepeoplerandom)
replacedrandom = complete(tempnomissrandom, 1)
...
paper_cor = cov(final, use="pairwise")
...
paperm = unlist(sapply(final, function(cl) list(means=mean(cl,na.rm=TRUE))))
